...
bool interpret(uint32_t pc, uint32_t inst) {
	switch((inst) >> (0x1a)) {
		case 0x0: {
			switch((inst) & (0x3f)) {
				case 0x0: {
				...
				case 0x3: {
					...
					TGPR(temp_3, rt);
					DO_LDS();
					if((rd) != (0x0)) { REG(rd) = (signed(temp_3)) >> (signed(shamt)); }
					return(true);
					break;
				}
				case 0x4: {
				...
				case 0x7: {
					...
					TGPR(temp_9, rt);
					DO_LDS();
					if((rd) != (0x0)) { REG(rd) = (signed(temp_9)) >> (signed(temp_8)); }
					return(true);
					break;
				}
				case 0x8: {
				...
				case 0x18: {
					...
					TGPR(temp_15, rt);
					DO_LDS();
					uint32_t _t = (temp_14) * (temp_15);
					uint32_t LO = cast(0x20, _t);
					uint32_t HI = cast(0x20, (_t) >> (0x20));
				...
				case 0x1a: {
					...
					if((temp_19) == (0x0)) {
						...
						if(((temp_18) == (0x80000000)) & ((temp_19) == (0xffffffff))) {
							uint32_t LO = 0x80000000;
							uint32_t HI = 0x0;
						} else {
							uint32_t LO = (signed(temp_18)) / (signed(temp_19));
							uint32_t HI = (signed(temp_18)) % (signed(temp_19));
				...
				case 0x1b: {
					...
					if((temp_21) == (0x0)) {
						...
						uint32_t LO = (temp_20) / (temp_21);
						uint32_t HI = (temp_20) % (temp_21);
						muldiv_delay(0x0, 0x0);
					}
					return(true);
					break;
				...
				case 0x2a: {
					...
					TGPR(temp_39, rt);
					DO_LDS();
					if((rd) != (0x0)) { REG(rd) = (signed(temp_38)) < (signed(temp_39)); }
					return(true);
					break;
				}
				case 0x2b: {
		...
		case 0xa: {
			...
			DO_LDS();
			uint32_t eimm = signext(0x10, imm);
			if((rt) != (0x0)) { REG(rt) = (signed(temp_82)) < (eimm); }
			return(true);
			break;
		}
		case 0xb: {
		...
		case 0x10: {
			switch(((inst) >> (0x15)) & (0x1f)) {
				case 0x0: {
					...
					RES(rt);
					DO_LDS();
					if((rt) != (0x0)) { defer_set(REG(rt), read_copreg(cop, rd)); }
					return(true);
					break;
				}
				case 0x2: {
		...
		case 0x20: {
			...
			if((rt) != (0x0)) { defer_set(REG(rt), signext(0x8, load_memory(0x8, (temp_95) + (offset), pc))); }
			return(true);
			break;
		}
		case 0x21: {
			...
			DO_LDS();
			uint32_t offset = signext(0x10, imm);
			if((rt) != (0x0)) { defer_set(REG(rt), signext(0x10, load_memory(0x10, (temp_96) + (offset), pc))); }
			return(true);
			break;
		}
		case 0x22: {
			...
			if((bottom) == (0x0)) {
				if((rt) != (0x0)) { defer_set(REG(rt), ((REG(rt)) & (0xffffff)) | ((load_memory(0x8, moffset, pc)) << (0x18))); }
			} else {
				if((bottom) == (0x1)) {
					if((rt) != (0x0)) { defer_set(REG(rt), ((REG(rt)) & (0xffff)) | ((load_memory(0x10, moffset, pc)) << (0x10))); }
				} else {
					if((bottom) == (0x2)) {
						if((rt) != (0x0)) { defer_set(REG(rt), ((REG(rt)) & (0xff)) | ((load_memory(0x18, moffset, pc)) << (0x8))); }
					} else {
						if((rt) != (0x0)) { defer_set(REG(rt), load_memory(0x20, moffset, pc)); }
					}
				}
			}
			return(true);
		...
		case 0x23: {
			...
			DO_LDS();
			uint32_t offset = signext(0x10, imm);
			if((rt) != (0x0)) { defer_set(REG(rt), load_memory(0x20, (temp_98) + (offset), pc)); }
			return(true);
			break;
		}
		case 0x24: {
			...
			DO_LDS();
			uint32_t offset = signext(0x10, imm);
			if((rt) != (0x0)) { defer_set(REG(rt), load_memory(0x8, (temp_99) + (offset), pc);); }
			return(true);
			break;
		}
		case 0x25: {
			...
			DO_LDS();
			uint32_t offset = signext(0x10, imm);
			if((rt) != (0x0)) { defer_set(REG(rt), load_memory(0x10, (temp_100) + (offset), pc);); }
			return(true);
			break;
		}
		case 0x26: {
			...
			uint32_t bottom = (offset) & (0x3);
			if((bottom) == (0x0)) {
				if((rt) != (0x0)) { defer_set(REG(rt), load_memory(0x20, offset, pc)); }
			} else {
				if((bottom) == (0x1)) {
					if((rt) != (0x0)) { defer_set(REG(rt), ((REG(rt)) & (0xff000000)) | (load_memory(0x18, offset, pc))); }
				} else {
					if((bottom) == (0x2)) {
						if((rt) != (0x0)) { defer_set(REG(rt), ((REG(rt)) & (0xffff0000)) | (load_memory(0x10, offset, pc))); }
					} else {
						if((rt) != (0x0)) { defer_set(REG(rt), ((REG(rt)) & (0xffffff00)) | (load_memory(0x8, offset, pc))); }
					}
				}
			}
			return(true);
